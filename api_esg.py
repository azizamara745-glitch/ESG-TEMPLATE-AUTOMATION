...
EMAIL_DESTINATAIRE = ["azizamara745@gmail.com", "malek.kharrat@dauphine.eu"]  # Liste des destinataires
EMAIL_MOT_DE_PASSE = " nfcn bpjh xbof htys" # ← REMPLACE ICI par tes 16 caractères
...
def _envoyer_email_avec_piece_jointe(sujet, corps, fichier_joint, nom_fichier):
    ...
    try:
        ...
        msg = MIMEMultipart()
        # Gestion liste ou adresse unique
        destinataires = EMAIL_DESTINATAIRE if isinstance(EMAIL_DESTINATAIRE, list) else [EMAIL_DESTINATAIRE]
        ...
        # Envoi à tous les destinataires via Gmail SSL
        ...
        print(f"  📧 Email envoyé à {destinataires} avec pièce jointe : {nom_fichier}")
